...
저는 학과생활을 하면서 많은 팀 프로젝트를 수행했습니다.팀원들과 의견 조율을 통해서 나온 주제에 맞게 제가 모르는 분야의 기술을 공부해야 하는 경우도 생기게 됩니다.
...
## So What?
가령 새로운 프로젝트를 기획하고 사용자에게 조금 더 편리함을 줄 수 있는 방법이 무엇인지를 생각하고 기획하는 부서는 새로운 것을 좋아하고 새로운 환경에 적응이 빠른 저의 성격이 기획부서와 잘 맞을 거라 생각합니다. <br> 
...
![ex_screenshot](./img/jedaero.png){: width="300" height="100"}  ![ex_screenshot](./img/1st.png) 
